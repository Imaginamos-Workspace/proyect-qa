...
import { FolderKanban, ShieldCheck, AlertTriangle, Gauge } from 'lucide-react';
...
export function ClientsPage() {
  ...
  const avgCoverage = totalClients
    ? Math.round(list.reduce((a, c) => a + c.coverage_pct, 0) / totalClients)
    : 0;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard title={t('clients.avgCoverage')} value={`${avgCoverage}%`} icon={Gauge} iconBg="#dbeafe" iconColor="#3b82f6" />
